...
// CreateUpdateHandler handles Cluster
...
func (h *CreateUpdateHandler) validatingFn(ctx context.Context, obj *clusterv1.Cluster) (bool, string, error) {
	...
	c, err := providerv1.ClusterSpecFromProviderSpec(obj.Spec.ProviderSpec)
	if err != nil {
